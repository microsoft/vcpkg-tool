...
describe('Acquire', () => {
  ...
  it('try some downloads', async () => {
    ...
    const remoteFile = fs.parseUri('https://raw.githubusercontent.com/microsoft/vscode/main/README.md');
  ...
  it('larger file', async () => {
    const remoteFile = fs.parseUri('https://user-images.githubusercontent.com/1487073/58344409-70473b80-7e0a-11e9-8570-b2efc6f8fa44.png');
