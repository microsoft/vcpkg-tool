...
import { selectArtifacts } from '@microsoft/vcpkg-ce/dist/cli/artifacts';
import { RegistryDatabase, RegistryResolver } from '@microsoft/vcpkg-ce/dist/registries/registries';
