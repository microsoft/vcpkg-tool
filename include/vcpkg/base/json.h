...
namespace vcpkg::Json
{
    ...
    ExpectedT<std::pair<Value, JsonStyle>, std::unique_ptr<Parse::IParseError>> parse_file(
        const Filesystem&, const fs::path&, std::error_code& ec) noexcept;
    ...
    std::pair<Value, JsonStyle> parse_file(vcpkg::LineInfo linfo, const Filesystem&, const fs::path&) noexcept;
