...
DECLARE_MESSAGE(AddVersionPortVersionShouldBeGone,
                (msg::package_name, msg::version),
                "",
                "The in {package_name}, {version} is completely new version, so the \"port-version\" field should be "
                "removed. Remove \"port-version\", commit that change, and try again. To skip this check, rerun with "
...
DECLARE_MESSAGE(AddVersionPortVersionShouldBeOneMore,
                ...
                "The in {package_name}, the current \"port-version\" for {version} is {count}, so the next added "
