...
namespace vcpkg::Paragraphs
{
    ...
    Parse::ParseExpected<SourceControlFile> try_load_port(const Filesystem& fs, const stdfs::path& path);
    ...
    std::vector<SourceControlFileLocation> load_overlay_ports(const Filesystem& fs, const stdfs::path& dir);
}
