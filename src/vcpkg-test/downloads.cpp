...
TEST_CASE ("details::split_uri_view", "[downloads]")
{
    {
        auto x = details::split_uri_view("https://github.com/Microsoft/vcpkg");
        REQUIRE(x.has_value());
    ...
    {
        auto x = details::split_uri_view("");
        REQUIRE(!x.has_value());
    }
    {
        auto x = details::split_uri_view("hello");
        REQUIRE(!x.has_value());
    }
    {
        auto x = details::split_uri_view("file:");
        REQUIRE(x.has_value());
    ...
    {
        auto x = details::split_uri_view("file://user:pw@host");
        REQUIRE(x.has_value());
        REQUIRE(x.get()->scheme == "file");
