...
TEST_CASE ("dependency-name-empty errors", "[manifests]")
{
    ...
    REQUIRE(m_pgh.error().data() ==
            ...
            "names must be lowercase alphanumeric+hypens and not reserved (see " + docs::manifests_url + 
...
TEST_CASE ("dependency-name-empty-object errors", "[manifests]")
{
    ...
    REQUIRE(m_pgh.error().data() ==
            ...
            "Package names must be lowercase alphanumeric+hypens and not reserved (see " + docs::manifests_url +
            " for more information).");
}
...
TEST_CASE ("dependency-feature-name-empty errors", "[manifests]")
{
    ...
    REQUIRE(m_pgh.error().data() ==
            ...
            "Feature names must be lowercase alphanumeric+hypens and not reserved (see " + docs::manifests_url +
            " for more information).");
}
...
TEST_CASE ("dependency-feature-name-empty-object errors", "[manifests]")
{
    ...
    REQUIRE(m_pgh.error().data() ==
            ...
            "name. Feature names must be lowercase alphanumeric+hypens and not reserved (see " + docs::manifests_url +
            " for more information).");
}
