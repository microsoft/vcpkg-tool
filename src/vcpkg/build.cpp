...
namespace vcpkg
{
    ...
    void BuildResultCounts::increment(const BuildResult build_result) noexcept
    {
        switch (build_result)
        {
    ...
    static void print_build_result_summary_line(Message build_result_message, unsigned int count)
    {
        if (count != 0)
        {
