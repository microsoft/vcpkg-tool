...
namespace
{
                                       ...
                                       bool keep_going)
    {
        ...
        auto maybe_versions = get_versions(paths.get_filesystem(), paths.current_registry_versions, port_name);
...
namespace vcpkg::Commands::AddVersion
{
    ...
    void perform_and_exit(const VcpkgCmdArguments& args, const VcpkgPaths& paths)
    {
        ...
        auto baseline_map = [&]() -> std::map<std::string, vcpkg::VersionT, std::less<>> {
            ...
            auto maybe_baseline_map =
                vcpkg::get_baseline(paths, paths.current_registry_dot_git_dir, paths.current_registry_versions);
