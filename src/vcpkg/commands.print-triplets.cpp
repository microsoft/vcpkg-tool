...
namespace vcpkg::Commands
{
    const CommandStructure COMMAND_STRUCTURE = {
        create_example_string(R"(x-print-triplets)"),
        0,
        0,
        {},
        nullptr,
    ...
    void PrintTriplets::perform_and_exit(const VcpkgCmdArguments& args,
                                         const VcpkgPaths&,
    ...
    void PrintTriplets::PrintTripletsCommand::perform_and_exit(const VcpkgCmdArguments& args,
                                                               const VcpkgPaths& paths,
                                                               Triplet default_triplet,
                                                               Triplet host_triplet) const
    {
        return PrintTriplets::perform_and_exit(args, paths, default_triplet, host_triplet);
    }
}
