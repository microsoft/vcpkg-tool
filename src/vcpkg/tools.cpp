...
namespace vcpkg
{
    ...
    struct ToolProvider
    {
        ...
        virtual VersionRequirement get_version_requirement() const {
            return VersionRequirement::MinimumOrGreater;
        };
    };
...
CMake suite maintained and supported by Kitware (kitware.com/cmake).
        ...
        // The CMake version is included in the ABI info. Allowing use of system
        // copies of CMake above a specified minimum version would make it
        // cumbersome to reuse binary caches generated by servers for local
        // development. If the server had a newer version of CMake, developers
        // building locally would have install the exact same version of CMake
        // and keep that version updated whenever the server is updated. This is
