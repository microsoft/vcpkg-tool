...
namespace vcpkg
{
    ...
    void VcpkgCmdArguments::append_common_options(HelpTableFormatter& table)
    {
        ...
        table.format(opt(REGISTRY_ROOT_DIR_ARG, "=", "<path>"), "(Experimental) Specify the root of a custom registry");
    ...
    constexpr StringLiteral VcpkgCmdArguments::REGISTRY_ROOT_DIR_ARG;
